...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let allSum = a + b + c;
  let allProduct = a * b * c;
  let thirdEl = `${a} and ${b} and ${c} sum to ${allSum}.`;
  let fourthEl = `The product of ${a} and ${b} and ${c} is ${allProduct}.`;

  return [allSum, allProduct, thirdEl, fourthEl];
}
